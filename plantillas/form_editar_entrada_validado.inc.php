<div class="container-fluid">
    ...
    <div class="row mx-auto py-1">
        <div class="col-md-8 d-flex flex-fill align-items-center p-0">
            <input type="checkbox" style="height:24px; width:24px" id="activa" name="activa" value="no" <?php if (!$_SESSION['entradaPrevia']->getActiva()) echo 'checked'; ?>><label class="ms-2" for="activa">Marca esta casilla para guardar la entrada como borrador</label>
        </div>
