...
<div class="card">
    <div class="card-header d-flex flex-fill bg-dark text-white p-3 fz-titulo">
        <h3 class="d-flex align-items-center">Y de&nbsp;
            ...
            &nbsp;3 entradas aleatorias <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>
        </h3>
    </div>
            ...
            <div class="row">
                ...
                ?>
                    <div class="col-lg-4 col-12 p-1">
                        <div class="card text-white bg-dark-light h-100">
                            ...
                            <div class="card-body d-flex flex-column bg-dark-light">
                                ...
                                <a class="btn btn-outline-light bg-rosa fz-sm-texto align-self-center mt-auto" role="button" href="<?php echo RUTA_ENTRADA . '/' . $entrada_actual->getUrl() ?>">
