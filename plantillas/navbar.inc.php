<header class="menu p-3 bg-dark text-white">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            ?>
            <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" method="POST" action="<?php echo RUTA_BUSQUEDA ?>">
                <div class="d-flex flex-fill flex-nowrap bg-dark-light rounded p-1">
                    <input type="search" name="buscar" class="form-control form-control-dark me-1" placeholder="Búsqueda..." aria-label="Search">
