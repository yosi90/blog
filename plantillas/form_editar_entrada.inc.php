<div class="container-fluid">
    <div class="row mx-auto">
        <input type="text" class="form-control textbox" placeholder="Título" maxlength="80" required="true" name="titulo" value="<?php echo $entrada->getTitulo(); ?>">
    </div>
    <div class="row mx-auto my-2">
        <textarea id="entrada" minlength="20" required="true" name="entrada"><?php echo $entrada->getTexto(); ?></textarea>
    </div>
