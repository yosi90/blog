<div class="container-fluid">
    ...
    <script>tinymce.init({ selector: '#entrada' });</script>
    <div class="row mx-auto my-2 mh-35">
        <textarea id="entrada" minlength="20" required="true" name="entrada"><?php $validador->mostrar_texto(); ?></textarea>
