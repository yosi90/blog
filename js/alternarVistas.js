...
function crearSVG() {
    ...
    switch (boton.value) {
        case '0':
            tamaño(document.getElementsByClassName('sizeControl'), 'mw-100', 'mw-25');
            ...
            break;
        case '1':
            tamaño(document.getElementsByClassName('sizeControl'), 'mw-50', 'mw-100');
            ...
            break;
        case '2':
            tamaño(document.getElementsByClassName('sizeControl'), 'mw-25', 'mw-50');
